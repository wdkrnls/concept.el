        ...
        ((concept-on-relationship-line)
         (let ((rel (concept-current-relationship)))
           (cond ((string= "take" rel)
                  (concept-insert-relationship-group "make"))
                 ((string= "give" rel)
                  (concept-insert-relationship-group "take"))
                 ((string= "have" rel)
                  (concept-insert-relationship-group "hold"))
                 (t
         ...
         (let ((key (concept-current-attribute))
           ...
           (cond ((and (string= "question" key)
                 ...
                 ((and (string= "line" key)
                  ...
                  (concept-insert-keyword-block "file-name"))
                 (concept-insert-keyword-block "file-name"))
                 ((string= "emacs-package" key)
                  (concept-insert-keyword-block "file-name"))
                 ((and (string= "file-name" key)
                       (not (member "emacs-package" keys)))
                  (concept-insert-keyword-block "emacs-package"))
                 ((string= "file-name" key)
                  (concept-insert-keyword-block "search-phrase"))
                 (t
